...
uploaded.";
            ...
            $insertStatement = "INSERT INTO artikel (artikelnr, titel, img, preis, katigorieid, beschreibung) VALUES (null, '" . $_POST["titel"] . "', '$target_file', '" . ((float) $_POST["preis"]) . "', '" . $_POST['katigorie'] . "', '" . $_POST["beschreibung"] . "');";
